...
import { Card, Button, Table, Tag, Tooltip, Typography, Space, Segmented, Alert,
         InputNumber, Input, Statistic, Row, Col, Popconfirm, App as AntApp } from 'antd';
...
export default function FactorLab({ rows, fields, light, archiveAllRows, archiveSliceCats, strategyCode, onStrategyCodeChange, onGoToStrategy }) {
  ...
  return (
    <Space direction="vertical" size={16} style={{ width: '100%' }}>
      ...
      {/* 4. 回测 */}
      {backtest && (
        <BacktestCard backtest={backtest} cutoff={cutoff} setCutoff={setCutoff} cutoffMin={cutoffMin}
          cutoffRecommend={cutoffRecommend} applyRecommendedCutoff={applyRecommendedCutoff}
      ...
      {factors.length > 0 && (
        <BaselineVsTrainCard strategyOptions={strategyOptions} baselineVsTrainStrategy={baselineVsTrainStrategy}
          onStrategyChange={setBaselineVsTrainStrategy} archiveAllRows={archiveAllRows}
          baselineVsTrain={baselineVsTrain} cutoff={cutoff} />
      )}
